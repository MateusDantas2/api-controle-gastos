...
@ControllerAdvice
public class ReleaseExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(ReleaseException.class)
    public ResponseEntity<Object> handleReleaseDoesNotExists(ReleaseException ex, WebRequest request) {
